...
export const supabaseAdapter: DbAdapter = {
  ...
  getPageSections: notConfigured,
  getSeoOverride: notConfigured,
  getPageMeta: notConfigured,
  getAllPageMeta: notConfigured,
  upsertPageSection: notConfigured,
  upsertSeoOverride: notConfigured,
  upsertPageMeta: notConfigured,
  deletePageSections: notConfigured,
  // ─── P4a — Pricing tiers + testimonials filtering ───
  getPricingTiers: notConfigured,
  getTestimonialsByProfession: notConfigured,
  getTestimonialsBySecteur: notConfigured,
  getTestimonialsByVille: notConfigured,
};
